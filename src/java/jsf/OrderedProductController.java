...
public class OrderedProductController implements Serializable {
    ...
    public OrderedProduct getSelected() {
        if (current == null) {
            ...
            current.setOrderedProductPK(new entities.OrderedProductPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public OrderedProduct getOrderedProduct(entities.OrderedProductPK id) {
    ...
    public static class OrderedProductControllerConverter implements Converter {
        ...
        entities.OrderedProductPK getKey(String value) {
